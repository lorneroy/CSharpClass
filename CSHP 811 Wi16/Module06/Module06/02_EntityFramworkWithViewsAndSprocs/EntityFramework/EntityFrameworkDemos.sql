...
Go
Create Table Orders
  ( OrderID int, CustomerId int, OrderDate datetime, Primary Key(OrderID) );
Go
Create Table OrderLineItems
  ( OrderID int, OrderLineItemID int, ProductID int, OrderQty int, OrderSalesPrice decimal(18,2), Primary Key(OrderID, ProductID) );
Go

--( Make the Foreign Key Constraints )--
Alter Table OrderLineItems Add Constraint fkOrderLineItemsToOrders
  Foreign Key([OrderID]) References Orders(OrderID)
Alter Table OrderLineItems Add Constraint fkOrderLineItemsToProducts
  Foreign Key([ProductID]) References Products(ProductID)
Alter Table Orders Add Constraint fkOrdersToCustomers
